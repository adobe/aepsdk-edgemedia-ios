...
@objc public extension Media {
    ...
    /// - Parameter:
    ///   - bitrate: The average bitrate of media in kbps.
    ///   - startupTime:  The duration (in seconds) between video load and start.
    ///   - fps: The current frame rate (in frames per second) information.
    ///   - droppedFrames: The number of frames dropped during playback of the main content.
